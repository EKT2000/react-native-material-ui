...
It can be embedded in a `FlatList` or a `SectionList` (or a `ListView`, but it is deprecated)
...
const propTypes = {
    ...
    */
    ...
    style: PropTypes.shape({
        ...
        primaryText: TextPropTypes.style,
        firstLine: View.propTypes.style,
        primaryTextContainer: TextPropTypes.style,
        secondaryText: TextPropTypes.style,
        tertiaryText: TextPropTypes.style,
